    ...
    <div>
      <footer className="text-gray-600 body-font">
        <div className="container py-8 mx-auto flex items-center sm:flex-row flex-col">
          <p className="text-sm md:text-md text-gray-500 sm:py-2 sm:mt-0 mt-4">
            © 2024 Leon Wang
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a
              className="ml-3 text-gray-500"
              href="https://www.linkedin.com/in/leonwangg/"
              target="_blank"
            >
              <svg
                fill="currentColor"
            ...
            <a
              className="ml-3 text-gray-500"
              href="https://github.com/leonwangg1"
              target="_blank"
            >
              <svg
            ...
            <a
              className="ml-3 text-gray-500"
              href="mailto: itsleonwang1@gmail.com"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
